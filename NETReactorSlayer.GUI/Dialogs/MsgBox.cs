...
namespace NETReactorSlayer.GUI.Dialogs
{
    internal class MsgBox : Form
    {
        ...
        public static void Show(string message, Form owner)
        {
            ...
            _msgBox._picIcon.Image = Properties.Resources.Info;
            ...
            _msgBox._plBase.Region = Region.FromHrgn(CreateRoundRectRgn(0, 0, _msgBox._plBase.Width, _msgBox._plBase.Height, 20, 20));
            if (owner != null)
        ...
        public static DialogResult Show(string message, string title, MsgButtons buttons, MsgIcon icon, AnimateStyle style, Form owner)
        {
            MessageBeep(0);
            _msgBox = new MsgBox();
            _msgBox._lblMessage.Text = message;
        ...
        private static void InitIcon(MsgIcon icon)
        {
            ...
            {
                case MsgIcon.Error:
                    _msgBox._picIcon.Image = Properties.Resources.Error;
                    break;
                ...
                case MsgIcon.Question:
                    _msgBox._picIcon.Image = Properties.Resources.Question;
                    break;

                case MsgIcon.Warning:
                    _msgBox._picIcon.Image = Properties.Resources.Warning;
                    break;
            }
        }
        ...
        private static Size MessageSize(string message)
        {
            ...
            SizeF size = g.MeasureString(message, new Font("Consolas", 10));
        ...
        void CloseAnimated()
        {
            ...
            timer.Tick += delegate
            {
                ...
                if (Opacity <= 0.0)
                {
                    ...
                    timer.Dispose();
                    //Prevent Flicker
                    this.FormClosed += new FormClosedEventHandler(async (sender, e) => { await Task.Delay(500); this.Dispose(); });
                    Close();
                }
            };
            timer.Start();
